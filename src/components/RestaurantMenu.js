            ...
            {!restaurant ? <ShimmerResCards />
                : <>
                    ...
                    <div className='max-w-6xl'>
                        {categories &&
                            categories.map((c) => c?.card?.card?.categories ? <ResSubMenuAccordian key={c?.card?.card?.categoryId} title={c?.card?.card?.title} list={c?.card?.card?.categories} resInfo={restaurant[2]?.card?.card?.info} /> : <ResMenuAccordian key={c?.card?.card?.title} title={c?.card?.card?.title} amount={c?.card?.card?.itemCards?.length} menu={c?.card?.card?.itemCards} resInfo={restaurant[2]?.card?.card?.info} />)
                        }
                    </div>
                </>}
        </div>
